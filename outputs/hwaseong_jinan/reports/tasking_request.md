...
- 무료 아카이브(Sentinel-2, GSD 10m)로 검출된 변화 폴리곤은 38개, **평균 면적 7,645 m²**였다.
...
> **보상 기준일(2022-02-21, 미확정 잠정값) 전후 비교**가 목적이라면, 기준일 직전과 직후를 각각 포함하도록 촬영 시점을 잡아야 한다. 기준일을 걸치는 한 쌍의 영상만으로는 변화가 기준일 전인지 후인지 특정할 수 없다.

## 4. 확인 필요 상업 조건

- $/km² 단가, 최소 주문 면적 (본 AOI 4.53 km² 규모 소량 주문 가능 여부)
